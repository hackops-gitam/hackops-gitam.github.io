...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 min-h-screen bg-black/0.8 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            {tiles.map((tile, index) => (
              <motion.div
                ...
                className="bg-navy-light/50 p-6 rounded-lg backdrop-blur-sm border border-gray-800 hover:border-cyan transition-colors"
              >
          ...
          {ongoingEvents.length > 0 && (
            <section className="mb-20">
              <h2 className="text-3xl font-bold mb-8 text-center text-white">Ongoing Events</h2>
