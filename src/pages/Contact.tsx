...
import { MapContainer, TileLayer, Marker } from 'react-leaflet'; // Using MapContainer for v5
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="border-b border-gray-700">
              <button
                ...
                className={`flex items-center gap-2 w-full text-left p-2 rounded text-sm font-medium text-white hover:bg-gray-800 focus:outline-none ${openFAQ === i ? 'bg-gray-800' : 'bg-navy-light'}`}
